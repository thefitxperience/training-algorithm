...
export const FIXTURES: Fixture[] = [
  {
    name: 'Reference',
    input: { sex: 'Male', age: 28, level: 'Intermediate', goal: 'Build Muscle', days: 4, split: 'Upper / Lower', equipment: 'Full gym', pains: {}, inbody: {}, vald: {}, bodydot: {}, pins: [], caps: [], structure: 'straight', absPlacement: 'end' },
    expectation: '4 days, ~40 exercises, sessions roughly 54–75 min, no fallback warnings.',
  },
  {
    name: 'New client',
    input: { sex: 'Female', age: 34, level: 'Beginner', goal: 'Lose Fat', days: 3, split: 'Full Body', equipment: 'Full gym', pains: {}, inbody: {}, vald: {}, bodydot: {}, pins: [], caps: [], structure: 'superset', absPlacement: 'end' },
    expectation: 'Beginner skill cap (skill ≤ 2) with female target overrides applied.',
  },
  {
    name: 'Youth strength',
    input: { sex: 'Male', age: 17, level: 'Advanced', goal: 'Get Stronger', days: 5, split: 'Push / Pull / Legs', equipment: 'Full gym', pains: {}, inbody: {}, vald: {}, bodydot: {}, pins: [], caps: [], structure: 'straight', absPlacement: 'end' },
    expectation: 'Get Stronger days should open on main lifts.',
  },
  {
    name: 'Older adult',
    input: { sex: 'Female', age: 68, level: 'Beginner', goal: 'Get Stronger', days: 4, split: 'Upper / Lower', equipment: 'Full gym', pains: {}, inbody: {}, vald: {}, bodydot: {}, pins: [], caps: [], structure: 'straight', absPlacement: 'end' },
    expectation:
  ...
  {
    name: 'Stress test',
    input: { sex: 'Male', age: 10, level: 'Beginner', goal: 'Build Muscle', days: 5, split: 'Muscle Group Per Day', equipment: 'Full gym', pains: {}, inbody: {}, vald: {}, bodydot: {}, pins: [], caps: [], structure: 'straight', absPlacement: 'end' },
